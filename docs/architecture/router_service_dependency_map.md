...
Generated at: `2026-06-09T23:41:45Z`
...
| `app/api_v2_routers/ether.py` | `app.api_v2_deps.auth` | `app.services.ether_service` | - | `app.core.database`, `sqlalchemy.ext.asyncio` |
...
| `app/api_v2_routers/judiciary.py` | `app.api_v2_deps.auth` | `app.services.judiciary_service_v2` | - | - |
...
| `app/api_v2_routers/lessons.py` | `app.api_v2_deps.auth` | `app.modules.lessons`, `app.modules.lessons.service`, `app.services.lesson_authorization` | - | `app.core.database`, `sqlalchemy.ext.asyncio` |
...
| `app/api_v2_routers/study_plans.py` | `app.api_v2_deps.auth` | `app.services.audit_service`, `app.services.study_plan_service_v2`, `app.services.telemetry` | `app.repositories.repositories`, `app.repositories.study_plan_repository` | `app.core.database`, `sqlalchemy.ext.asyncio` |
