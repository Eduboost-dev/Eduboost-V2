...
| `lessons` | `generate_lesson_stream` | `app/api_v2_routers/lessons.py` | 67 | True | False | `route-transaction-wiring-not-proven` |
| `lessons` | `get_lesson` | `app/api_v2_routers/lessons.py` | 91 | True | False | `route-transaction-wiring-not-proven` |
| `lessons` | `complete_lesson` | `app/api_v2_routers/lessons.py` | 111 | True | False | `route-transaction-wiring-not-proven` |
| `lessons` | `sync_lessons` | `app/api_v2_routers/lessons.py` | 128 | True | False | `route-transaction-wiring-not-proven` |
