...
Generated at: `2026-06-08T15:27:48Z`
...
| `app/api_v2_routers/auth_extended.py` | `_invalidate_existing_tokens` | 192 | `single-mutation-candidate` | `-` | `execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `_create_secure_token` | 210 | `multi-write-candidate-not-proven` | `-` | `add, flush` | `-` |
| `app/api_v2_routers/auth_extended.py` | `_consume_token` | 230 | `single-mutation-candidate` | `-` | `execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `forgot_password` | 263 | `multi-write-candidate-not-proven` | `-` | `commit, execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `reset_password` | 299 | `single-mutation-candidate` | `-` | `commit` | `-` |
| `app/api_v2_routers/auth_extended.py` | `send_verification` | 319 | `single-mutation-candidate` | `-` | `commit` | `-` |
| `app/api_v2_routers/auth_extended.py` | `verify_email` | 349 | `multi-write-candidate-not-proven` | `-` | `add, commit, execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `get_onboarding` | 390 | `multi-write-candidate-not-proven` | `-` | `add, commit, execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `update_onboarding_step` | 411 | `multi-write-candidate-not-proven` | `-` | `add, commit, execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `update_learner_profile` | 451 | `multi-write-candidate-not-proven` | `-` | `add, commit, execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `get_privacy_settings` | 501 | `multi-write-candidate-not-proven` | `-` | `add, commit, execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `update_privacy_settings` | 519 | `multi-write-candidate-not-proven` | `-` | `add, commit, execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `request_data_export` | 543 | `multi-write-candidate-not-proven` | `-` | `add, commit, execute` | `-` |
| `app/api_v2_routers/auth_extended.py` | `request_account_deletion` | 570 | `multi-write-candidate-not-proven` | `-` | `add, commit, execute` | `-` |
| `app/api_v2_routers/consent.py` | `grant_consent` | 40 | `multi-write-candidate-not-proven` | `popia_lifecycle` | `grant` | `-` |
| `app/api_v2_routers/consent.py` | `revoke_consent` | 73 | `multi-write-candidate-not-proven` | `popia_lifecycle` | `revoke` | `-` |
...
| `app/api_v2_routers/content_factory.py` | `plan_full_generation` | 1100 | `multi-write-candidate-not-proven` | `-` | `add, flush` | `-` |
| `app/api_v2_routers/content_factory.py` | `start_full_generation` | 1134 | `single-mutation-candidate` | `-` | `flush` | `-` |
| `app/api_v2_routers/content_factory.py` | `list_full_generation_runs` | 1169 | `single-mutation-candidate` | `-` | `execute` | `-` |
| `app/api_v2_routers/content_factory.py` | `cancel_full_generation_run` | 1228 | `multi-write-candidate-not-proven` | `-` | `execute, flush` | `-` |
| `app/api_v2_routers/content_factory.py` | `resume_full_generation_run` | 1263 | `single-mutation-candidate` | `-` | `flush` | `-` |
...
| `app/api_v2_routers/learners.py` | `create_learner` | 27 | `single-mutation-candidate` | `-` | `create` | `-` |
| `app/api_v2_routers/learners.py` | `request_erasure` | 125 | `single-mutation-candidate` | `-` | `delete` | `-` |
...
| `app/services/content_staging_seed_executor.py` | `seed_staging` | 124 | `transaction-marker-present` | `-` | `add, execute` | `rollback` |
| `app/services/content_staging_seed_executor.py` | `list_seed_runs` | 381 | `single-mutation-candidate` | `-` | `execute` | `-` |
| `app/services/content_staging_seed_executor.py` | `list_seed_run_items` | 404 | `single-mutation-candidate` | `-` | `execute` | `-` |
| `app/services/content_staging_seed_executor.py` | `rollback_seed_run` | 429 | `transaction-marker-present` | `-` | `execute, flush` | `rollback` |
| `app/services/content_staging_seed_executor.py` | `_plan_seed` | 466 | `single-mutation-candidate` | `-` | `execute` | `-` |
