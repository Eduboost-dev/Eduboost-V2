...
- Frontend journey evidence is indexed by
  `docs/frontend/frontend_journey_evidence.md` and checked by
  `make frontend-journey-check`; staging browser E2E remains open.
