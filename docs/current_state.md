...
- Accessibility/PWA/E2E evidence is indexed by
  `docs/frontend/accessibility_pwa_e2e_evidence.md` and checked by
  `make accessibility-pwa-e2e-check`; staging Playwright remains open.
