...
Generated at: `2026-06-05T20:19:18Z`

| Check | Return code | Command |
|---|---:|---|
| consent runtime compatibility | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_consent_runtime_compatibility_slice.py` |
| audit registry | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_registry.py` |
| implementation foundation | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_backend_consolidation_implementation_foundation.py` |
| schema/deep/audit slice | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_slice.py` |
...
Command: `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_consent_runtime_compatibility_slice.py`
...
Command: `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_registry.py`
...
Command: `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_backend_consolidation_implementation_foundation.py`
...
Command: `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_slice.py`
