...
Generated at: `2026-06-08T15:23:14Z`

| Check | Return code | Command |
|---|---:|---|
| consent runtime compatibility | 0 | `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/check_consent_runtime_compatibility_slice.py` |
| audit registry | 0 | `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_registry.py` |
...
| schema/deep/audit slice | 0 | `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_slice.py` |
...
Command: `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/check_consent_runtime_compatibility_slice.py`
...
Command: `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_registry.py`
...
Command: `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_slice.py`
