...
Generated at: `2026-06-01T15:03:38Z`

| Check | Return code | Command |
|---|---:|---|
| consent/deep readiness wiring | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_first_consent_and_deep_readiness_runtime_wiring.py` |
| destructive-action scan | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_runtime_wiring_no_destructive_actions.py` |
| first audit runtime wiring | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_first_audit_runtime_wiring.py` |
| runtime enablement | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_backend_runtime_enablement_guard.py` |
...
Command: `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_runtime_wiring_no_destructive_actions.py`
...
Command: `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_backend_runtime_enablement_guard.py`
