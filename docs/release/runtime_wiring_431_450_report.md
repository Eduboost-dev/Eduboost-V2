...
Generated at: `2026-05-28T12:30:31Z`

| Check | Return code | Command |
|---|---:|---|
| consent/deep readiness wiring | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_first_consent_and_deep_readiness_runtime_wiring.py` |
| destructive-action scan | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_runtime_wiring_no_destructive_actions.py` |
| first audit runtime wiring | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_first_audit_runtime_wiring.py` |
| runtime enablement | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_backend_runtime_enablement_guard.py` |
...
Command: `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_runtime_wiring_no_destructive_actions.py`
...
Command: `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_backend_runtime_enablement_guard.py`
