...
Generated at: `2026-06-08T15:21:11Z`

| Check | Return code | Command |
|---|---:|---|
| runtime wiring cases | 0 | `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/check_backend_runtime_wiring_cases.py` |
...
| implementation 376-382 | 0 | `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/generate_backend_runtime_wiring_preflight_report.py` |
...
Command: `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/check_backend_runtime_wiring_cases.py`
...
Command: `/home/azureuser/Dev/SandBox/ml/Eduboost-V2/.venv/bin/python scripts/generate_backend_runtime_wiring_preflight_report.py`

Return code: `0`

```text
Wrote /home/azureuser/Dev/SandBox/ml/Eduboost-V2/docs/release/backend_runtime_wiring_preflight_report.md
```
