...
Generated at: `2026-06-08T12:35:03Z`

| Check | Return code | Command |
|---|---:|---|
| backend implementation 371-375 | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python3.11 scripts/check_backend_implementation_371_375.py` |
| audit registry | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python3.11 scripts/check_audit_canonicalization_registry.py` |
| consent runtime | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python3.11 scripts/check_consent_runtime_compatibility_slice.py` |
| deep readiness | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python3.11 scripts/check_deep_readiness_readonly_guard.py` |
...
Command: `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python3.11 scripts/check_deep_readiness_readonly_guard.py`
