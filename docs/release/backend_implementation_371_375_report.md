...
Generated at: `2026-05-28T12:15:05Z`

| Check | Return code | Command |
|---|---:|---|
| backend implementation 371-375 | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_backend_implementation_371_375.py` |
| audit registry | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_registry.py` |
| consent runtime | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_consent_runtime_compatibility_slice.py` |
| deep readiness | 0 | `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_deep_readiness_readonly_guard.py` |
...
Command: `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_audit_canonicalization_registry.py`
...
Command: `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_consent_runtime_compatibility_slice.py`
...
Command: `/home/nkgolol/Dev/Development/Eduboost-V2/.venv/bin/python scripts/check_deep_readiness_readonly_guard.py`
