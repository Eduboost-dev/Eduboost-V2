...
Generated at: `2026-05-28T12:09:13Z`
...
|---|---:|---|---|---|---:|
| `final_beta_gate_refresh` | True | `NO-GO` | `NO-GO` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `release_go_no_go_status` | True | `NO-GO` | `NO-GO` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `ci_evidence` | True | `ci-evidence-not-accepted` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `ci_run_evidence` | True | `external-blocked` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `external_approval` | True | `external-blocked` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `approval_evidence` | True | `external-blocked` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `staging_smoke_evidence` | True | `staging-smoke-evidence-not-accepted` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `staging_acceptance` | True | `external-blocked` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `auth_refresh_db_evidence` | True | `auth-refresh-db-evidence-accepted` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `popia_response_contract_no_skip` | True | `popia-response-contract-no-skip-passing` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `diag_deep_health_runtime` | True | `diag-deep-health-runtime-not-accepted` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `live_db_transaction_evidence` | True | `external-blocked` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `beta_blocker_burndown` | True | `` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
| `docs_inventory` | True | `` | `` | `80170cbc24b1379aeaf351f1c4f387c65bc502ca` | False |
