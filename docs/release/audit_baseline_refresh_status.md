...
|---|---:|---|---|---|---:|
| `final_beta_gate_refresh` | True | `NO-GO` | `NO-GO` | `b33e49720860a084e7a7c42ead1b620cb859e64f` | False |
| `release_go_no_go_status` | True | `NO-GO` | `NO-GO` | `b33e49720860a084e7a7c42ead1b620cb859e64f` | False |
...
| `approval_evidence` | True | `external-blocked` | `` | `b33e49720860a084e7a7c42ead1b620cb859e64f` | False |
...
| `auth_refresh_db_evidence` | True | `auth-refresh-db-evidence-accepted` | `` | `549b25c96fac85546a45fa4337722425d928a0fe` | True |
...
| `docs_inventory` | True | `` | `` | `b33e49720860a084e7a7c42ead1b620cb859e64f` | False |
