...
Generated at: `2026-06-01T14:37:47Z`
...
| destructive-action guard | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_first_audit_runtime_wiring_no_destructive_actions.py` |
| runtime enablement guard | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_backend_runtime_enablement_guard.py` |
| first wiring candidates | 0 | `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_backend_first_wiring_candidates.py` |
...
Command: `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_first_audit_runtime_wiring_no_destructive_actions.py`
...
Command: `/home/azureuser/Dev/Eduboost-V2/.venv/bin/python scripts/check_backend_first_wiring_candidates.py`
