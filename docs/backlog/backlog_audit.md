...
| 17 | TODO-273 | critical | Missing | security/backend | Validate production CORS; no wildcard origins with credentials. | wsl_copilot.sh; EduBoost_Technical_Status_Report.md; SECURITY.md; LLM_Integration_Roadmap.md; CHANGELOG.md; RoadMap.md; .env.example; bicep/container_apps.bicep |
...
| TODO-028 | high | Human-decision | Audit dependency files and decide canonical dependency paths for runtime, dev, docs, and ML extras. | wsl_copilot.sh; pytest.ini; Makefile; prometheus.yml; .agent.md; CONTRIBUTING.md; EduBoost_Technical_Status_Report.md; README.md |
...
| TODO-057 | medium | Blocked | Add slow-query logging in staging and production. | EduBoost_Technical_Status_Report.md; CHANGELOG.md; coverage_html/status.json; docs/api_v2.md; app/api_v2.py; docker/inference_server.py; .import_linter_cache/3aba9e28428eba0e4969263086dae345455662fc.data.json; .import_linter_cache/app.meta.json |
...
| TODO-273 | critical | Missing | Validate production CORS; no wildcard origins with credentials. | wsl_copilot.sh; EduBoost_Technical_Status_Report.md; SECURITY.md; LLM_Integration_Roadmap.md; CHANGELOG.md; RoadMap.md; .env.example; bicep/container_apps.bicep |
...
| TODO-275 | critical | Missing | Sanitize user-generated content. | EduBoost_Technical_Status_Report.md; LLM_Integration_Roadmap.md; RoadMap.md; coverage_html/coverage_html_cb_dd2e7eb5.js; coverage_html/style_cb_9ff733b0.css; bicep/container_apps.parameters.json; docs/openapi.json; docs/popia_erasure.md |
...
| TODO-219 | critical | Missing | Define local, test, staging, and production environments. | RoadMap.md; bicep/container_apps.bicep; docs/AI_AGENT_SKILLS_MANIFEST.md; docs/v2_migration.md; docs/backlog/backlog_audit.md; data/caps/text/training-data/raw/caps/grades-r-3/general/unknown-language/caps-errata-grade-12-and-sp.txt; data/caps/text/training-data/raw/caps/grades-7-9/general/unknown-language/social-science.txt; data/caps/text/training-data/raw/caps/grades-7-9/general/unknown-language/caps-errata-grade-12-and-sp.txt |
...
| TODO-015 | critical | Blocked | Logs, metrics, traces, alerts, and dashboards are live before real learner data is processed. | pytest.ini; docker-compose.prod.yml; CODE_OF_CONDUCT.md; docker-compose.yml; prometheus.yml; CONTRIBUTING.md; EduBoost_Technical_Status_Report.md; playwright.config.ts |
| TODO-319 | critical | Missing | Hide unnecessary PII from support roles. | pytest.ini; CONTRIBUTING.md; SECURITY.md; CHANGELOG.md; coverage_html/coverage_html_cb_dd2e7eb5.js; bicep/main.bicep; docs/index.md; docs/LLM_Phase3_Finetuning.md |
...
| TODO-404 | high | Missing | Announce limited scope accurately. | CODE_OF_CONDUCT.md; .agent.md; EduBoost_Technical_Status_Report.md; LLM_Integration_Roadmap.md; RoadMap.md; docs/popia_erasure.md; docs/secrets.md; docs/release_checklist.md |
