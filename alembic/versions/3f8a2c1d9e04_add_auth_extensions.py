...
def upgrade() -> None:
    ...
    # ── display_name, grade, home_language on users ───────────────────────────
    op.add_column("users", sa.Column("display_name",  sa.String(120), nullable=True))
    op.add_column("users", sa.Column("grade",         sa.String(4),   nullable=True))
    op.add_column("users", sa.Column("home_language", sa.String(8),   nullable=True))


def downgrade() -> None:
    op.drop_column("users", "home_language")
