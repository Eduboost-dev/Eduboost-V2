...
class SecureToken(Base):
    ...
    user = relationship("User", back_populates="secure_tokens", lazy="raise")
...
class OnboardingState(Base):
    ...
    user = relationship("User", back_populates="onboarding_state", lazy="raise")
...
class PrivacySettings(Base):
    ...
    user = relationship("User", back_populates="privacy_settings", lazy="raise")
