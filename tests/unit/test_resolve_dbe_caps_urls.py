...
def test_resolve_targets_matches_section_and_label_pairs() -> None:
    links = [
        Link("Mathematics", "English", "https://example.test/foundation-maths.pdf"),
        Link("Mathematics Grade R", "English", "https://example.test/grade-r-maths.pdf"),
        Link("First Additional Language", "Sepedi", "https://example.test/sepedi-fal.pdf"),
        Link("NON LANGUAGES IN ENGLISH", "Mathematics", "https://example.test/senior-maths.pdf"),
    ]
...
def test_resolve_targets_does_not_fall_back_to_wrong_phase_subject() -> None:
    links = [Link("Mathematics", "English", "https://example.test/foundation-maths.pdf")]
